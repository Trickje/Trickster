...
struct Batch
{
    ...
    // Information about the list of indexed triangles to be rendered. The offset, in bytes,
    // to the last pointer returned by MapVertices() is stored in 'vertexOffset'. Indices are 
    // 16 bits each and they start at the last pointer returned by MapIndices() plus 'startIndex'
